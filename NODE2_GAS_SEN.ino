...
char auth[] = "120e54b4b0de435385b4438f30879f9a";
...
BLYNK_CONNECTED() {
  bridge1.setAuthToken("3f72f769a9f34eaaa733d3df5d3dcfb4"); // Place the AuthToken of the second hardware here
}
...
{
    bridge1.virtualWrite(V1,airqual);
}
